...
public class EndpointNamespace {
    ...
    final public static String CREDIT_LIMITS  = "/credit-limits";

    final public static String CREDIT_RATINGS  = "/credit-ratings";
    ...
    final public static String UK_DOCUMENTS = "/documents";
