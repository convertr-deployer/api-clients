 ...
 * Package: com.duedil.io.client.entity
 */
public class DuedilRayRoiDocuments extends Entity {
    private String id;
    ...
    public String toString() {
        return "DuedilRayRoiDocuments{" +
                ...
                ", submissionDocumentNumber='" + submissionDocumentNumber + '\'' +
                ", submissionTypeCode='" + submissionTypeCode + '\'' +
                ", submissionTypeDescription='" + submissionTypeDescription + '\'' +
                ", documentTypeCode='" + documentTypeCode + '\'' +
                ", documentTypeDescription='" + documentTypeDescription + '\'' +
                ", submissionStatus='" + submissionStatus + '\'' +
                ", submissionStatusDescription='" + submissionStatusDescription + '\'' +
                ", dataset=" + dataset +
                '}';
    }
}
