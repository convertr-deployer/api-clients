 ...
 * Package: com.duedil.io.client.entity
 */
public class DuedilRayCompanies extends Entity {
    private String id;
    ...
    public String getCreditRatingDescription() {
        return creditRatingDescription;
    }

    public void setCreditRatingDescription(String creditRatingDescription) {
        this.creditRatingDescription = creditRatingDescription;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (creditLimitLatestDate != null ? !creditLimitLatestDate.equals(that.creditLimitLatestDate) : that.creditLimitLatestDate != null)
            return false;
        if (creditRatingDescription != null ? !creditRatingDescription.equals(that.creditRatingDescription) : that.creditRatingDescription != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (creditRatingDescription != null ? creditRatingDescription.hashCode() : 0);
