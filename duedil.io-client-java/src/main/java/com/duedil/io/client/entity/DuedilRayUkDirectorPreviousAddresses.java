 ...
 * Package: com.duedil.io.client.entity
 */
public class DuedilRayUkDirectorPreviousAddresses extends Entity{
    private String id;
    ...
    private String addressDateOfChange;

    public String getAddressDateOfChange() {
        return addressDateOfChange;
    }

    public void setAddressDateOfChange(String addressDateOfChange) {
        this.addressDateOfChange = addressDateOfChange;
    }
    ...
    public boolean equals(Object o) {
        ...
        DuedilRayUkDirectorPreviousAddresses that = (DuedilRayUkDirectorPreviousAddresses) o;
        ...
        if (addressDateOfChange != null ? !addressDateOfChange.equals(that.addressDateOfChange) : that.addressDateOfChange != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (addressDateOfChange != null ? addressDateOfChange.hashCode() : 0);
    ...
    public String toString() {
        return "DuedilRayUkDirectorPreviousAddresses{" +
                "id='" + id + '\'' +
                ", addressDateOfChange='" + addressDateOfChange + '\'' +
