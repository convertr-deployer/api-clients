 ...
 * Package: com.duedil.io.client.entity
 */
public class DuedilRayGaapAccounts extends Entity {
    private String id;
    ...
    private double bankLoansLt;

    public double getBankLoansLt() {
        return bankLoansLt;
    }

    public void setBankLoansLt(double bankLoansLt) {
        this.bankLoansLt = bankLoansLt;
    }
    ...
    private double cashIncreaseDecrease;

    public double getCashIncreaseDecrease() {
        return cashIncreaseDecrease;
    }

    public void setCashIncreaseDecrease(double cashIncreaseDecrease) {
        this.cashIncreaseDecrease = cashIncreaseDecrease;
    }
    ...
    private double debtorsDue;

    public double getDebtorsDue() {
        return debtorsDue;
    }

    public void setDebtorsDue(double debtorsDue) {
        this.debtorsDue = debtorsDue;
    }
    ...
    private double directorsAccountsLt;

    public double getDirectorsAccountsLt() {
        return directorsAccountsLt;
    }

    public void setDirectorsAccountsLt(double directorsAccountsLt) {
        this.directorsAccountsLt = directorsAccountsLt;
    }
    ...
    public double getFinancingNetCashflow() {
        return financingNetCashflow;
    }

    public void setFinancingNetCashflow(double financingNetCashflow) {
        this.financingNetCashflow = financingNetCashflow;
    }
    ...
    private double groupAccountsLt;

    public double getGroupAccountsLt() {
        return groupAccountsLt;
    }

    public void setGroupAccountsLt(double groupAccountsLt) {
        this.groupAccountsLt = groupAccountsLt;
    }
    ...
    private double liabilitiesOtherLt;

    public double getLiabilitiesOtherLt() {
        return liabilitiesOtherLt;
    }

    public void setLiabilitiesOtherLt(double liabilitiesOtherLt) {
        this.liabilitiesOtherLt = liabilitiesOtherLt;
    }
    ...
    private double liabilitiesTotalLt;

    public double getLiabilitiesTotalLt() {
        return liabilitiesTotalLt;
    }

    public void setLiabilitiesTotalLt(double liabilitiesTotalLt) {
        this.liabilitiesTotalLt = liabilitiesTotalLt;
    }
    ...
    private double netOperationsCashflow;

    public double getNetOperationsCashflow() {
        return netOperationsCashflow;
    }

    public void setNetOperationsCashflow(double netOperationsCashflow) {
        this.netOperationsCashflow = netOperationsCashflow;
    }
    ...
    private double otherLoansLt;

    public double getOtherLoansLt() {
        return otherLoansLt;
    }

    public void setOtherLoansLt(double otherLoansLt) {
        this.otherLoansLt = otherLoansLt;
    }
    ...
    private double stocksAndWorkInProgress;

    public double getStocksAndWorkInProgress() {
        return stocksAndWorkInProgress;
    }

    public void setStocksAndWorkInProgress(double stocksAndWorkInProgress) {
        this.stocksAndWorkInProgress = stocksAndWorkInProgress;
    }
    ...
    private double totalLtLoans;

    public double getTotalLtLoans() {
        return totalLtLoans;
    }

    public void setTotalLtLoans(double totalLtLoans) {
        this.totalLtLoans = totalLtLoans;
    }

    private double totalNonCurrentHpLeaseCommitments;

    public double getTotalNonCurrentHpLeaseCommitments() {
        return totalNonCurrentHpLeaseCommitments;
    }

    public void setTotalNonCurrentHpLeaseCommitments(double totalNonCurrentHpLeaseCommitments) {
        this.totalNonCurrentHpLeaseCommitments = totalNonCurrentHpLeaseCommitments;
    }
    ...
    public boolean equals(Object o) {
        ...
        DuedilRayGaapAccounts that = (DuedilRayGaapAccounts) o;
        ...
        if (Double.compare(that.bankLoans, bankLoans) != 0) return false;
        if (Double.compare(that.bankLoansLt, bankLoansLt) != 0) return false;
        ...
        if (Double.compare(that.cashIncreaseDecrease, cashIncreaseDecrease) != 0) return false;
        ...
        if (Double.compare(that.debtorsDue, debtorsDue) != 0) return false;
        ...
        if (Double.compare(that.directorsAccountsLt, directorsAccountsLt) != 0) return false;
        ...
        if (Double.compare(that.financingNetCashflow, financingNetCashflow) != 0) return false;
        ...
        if (Double.compare(that.groupAccountsLt, groupAccountsLt) != 0) return false;
        ...
        if (Double.compare(that.liabilitiesOtherLt, liabilitiesOtherLt) != 0) return false;
        if (Double.compare(that.liabilitiesTotalCurrent, liabilitiesTotalCurrent) != 0) return false;
        if (Double.compare(that.liabilitiesTotalLt, liabilitiesTotalLt) != 0) return false;
        ...
        if (Double.compare(that.netOperationsCashflow, netOperationsCashflow) != 0) return false;
        ...
        if (Double.compare(that.otherLoansLt, otherLoansLt) != 0) return false;
        ...
        if (Double.compare(that.stocksAndWorkInProgress, stocksAndWorkInProgress) != 0) return false;
        ...
        if (Double.compare(that.totalLtLoans, totalLtLoans) != 0) return false;
        if (Double.compare(that.totalNonCurrentHpLeaseCommitments, totalNonCurrentHpLeaseCommitments) != 0)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = bankLoans != +0.0d ? Double.doubleToLongBits(bankLoans) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = bankLoansLt != +0.0d ? Double.doubleToLongBits(bankLoansLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = cashIncreaseDecrease != +0.0d ? Double.doubleToLongBits(cashIncreaseDecrease) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = debtorsDue != +0.0d ? Double.doubleToLongBits(debtorsDue) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = directorsAccountsLt != +0.0d ? Double.doubleToLongBits(directorsAccountsLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = financingNetCashflow != +0.0d ? Double.doubleToLongBits(financingNetCashflow) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = groupAccountsLt != +0.0d ? Double.doubleToLongBits(groupAccountsLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = liabilitiesOtherLt != +0.0d ? Double.doubleToLongBits(liabilitiesOtherLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = liabilitiesTotalCurrent != +0.0d ? Double.doubleToLongBits(liabilitiesTotalCurrent) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = liabilitiesTotalLt != +0.0d ? Double.doubleToLongBits(liabilitiesTotalLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        temp = netOperationsCashflow != +0.0d ? Double.doubleToLongBits(netOperationsCashflow) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = otherLoansLt != +0.0d ? Double.doubleToLongBits(otherLoansLt) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = stocksAndWorkInProgress != +0.0d ? Double.doubleToLongBits(stocksAndWorkInProgress) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        ...
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = totalLtLoans != +0.0d ? Double.doubleToLongBits(totalLtLoans) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
        temp = totalNonCurrentHpLeaseCommitments != +0.0d ? Double.doubleToLongBits(totalNonCurrentHpLeaseCommitments) : 0L;
        result = 31 * result + (int) (temp ^ (temp >>> 32));
    ...
    public String toString() {
        return "DuedilRayGaapAccounts{" +
                ...
                ", bankLoans=" + bankLoans +
                ", bankLoansLt=" + bankLoansLt +
                ", bankOverdraft=" + bankOverdraft +
                ", capitalExpenditure=" + capitalExpenditure +
                ", cash=" + cash +
                ", cashIncreaseDecrease=" + cashIncreaseDecrease +
                ...
                ", directorsAccountsLt=" + directorsAccountsLt +
                ...
                ", groupAccountsLt=" + groupAccountsLt +
                ...
                ", liabilitiesOtherLt=" + liabilitiesOtherLt +
                ", liabilitiesTotalCurrent=" + liabilitiesTotalCurrent +
                ", liabilitiesTotalLt=" + liabilitiesTotalLt +
                ...
                ", months=" + months +
                ", netOperationsCashflow=" + netOperationsCashflow +
                ...
                ", stocksAndWorkInProgress=" + stocksAndWorkInProgress +
                ", tax=" + tax +
                ", taxation=" + taxation +
                ", totalCalledIssuedCapital=" + totalCalledIssuedCapital +
                ", totalLtLoans=" + totalLtLoans +
                ", totalNonCurrentHpLeaseCommitments=" + totalNonCurrentHpLeaseCommitments +
